...
class ActiveInactiveFlag1 extends StatefulWidget {
  const ActiveInactiveFlag1({super.key});

  @override
  State<ActiveInactiveFlag1> createState() => _ActiveInactiveFlag1State();
}

class _ActiveInactiveFlag1State extends State<ActiveInactiveFlag1> {
